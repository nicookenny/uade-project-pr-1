import os
import Medicos
import FuncionPacientes
import FuncionTurnos
...
def menuPacientes():
    ...
    while True:
        ...
        opcion = int(input("Ingresar una Opcion: "))
        if opcion == 1:
            FuncionPacientes.mostrarLista()
        elif opcion == 2:
            FuncionPacientes.agregarPaciente()
        elif opcion == 3:
            FuncionPacientes.eliminarPaciente()
        elif opcion == 4:
            FuncionPacientes.modificarPaciente()
        elif opcion == 0:
            os.system('cls')
            return
        else: 
...
def menuTurnos():
    ...
    while True:
        ...
        opcion = int(input("Ingresar una Opcion: "))
        if opcion == 1:
            FuncionTurnos.agendarTurno()
        elif opcion == 2:
            FuncionTurnos.cancelarTurno()
        elif opcion == 0:
            os.system('cls')
            return
